...
typedef enum {
	...
	HD44780_INTERFACE_8bit /**< Interfacciamento a otto bit */
 ...
 */
typedef struct {
	PortPinPair_t 	RS;						/**< Coppia porta-pin a cui e' associato il segnale RS del display LCD */
	PortPinPair_t 	RW;						/**< Coppia porta-pin a cui e' associato il segnale RW del display LCD */
	PortPinPair_t 	E;						/**< Coppia porta-pin a cui e' associato il segnale E del display LCD */
	PortPinPair_t 	Data7;					/**< Coppia porta-pin a cui e' associato il segnale D7 del display LCD */
	PortPinPair_t 	Data6;					/**< Coppia porta-pin a cui e' associato il segnale D6 del display LCD */
	PortPinPair_t 	Data5;					/**< Coppia porta-pin a cui e' associato il segnale D5 del display LCD */
	PortPinPair_t 	Data4;					/**< Coppia porta-pin a cui e' associato il segnale D4 del display LCD */
	PortPinPair_t 	Data3;					/**< Coppia porta-pin a cui e' associato il segnale D3 del display LCD */
	PortPinPair_t 	Data2;					/**< Coppia porta-pin a cui e' associato il segnale D2 del display LCD */
	PortPinPair_t 	Data1;					/**< Coppia porta-pin a cui e' associato il segnale D1 del display LCD */
	PortPinPair_t 	Data0;					/**< Coppia porta-pin a cui e' associato il segnale D0 del display LCD */
	HD44780_InterfaceMode_t InterfaceMode;	/**< modalita' di funzionamento dell'interfaccia verso il displau (4 oppure 8 bit) */
} HD44780_LCD_t;
 ...
 * inizializzata.
 *
 * @param[inout]	lcd 	struttura di tipo HD44780_LCD_t che descrive un display HD44780 da inizializzare
 * @param[in]		RS 		struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale RS (data/command)
 * @param[in] 		RW		struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale RW (read/write)
 * @param[in] 		E 		struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale E (Enable)
 * @param[in] 		Data7 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data7
 * @param[in] 		Data6	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data6
 * @param[in]		Data5	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data5
 * @param[in]		Data4	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 		 					segnale Data4
 *
 ...
 * @endcode
 *
 * @warning E' necessario abilitare il clock dei GPIO!<br>
 ...
 * @warning Non modificare i campi della struttura dopo che essa sia stata inizializzata.
 *
 * @param[inout]	lcd			struttura di tipo HD44780_LCD_t che descrive un display HD44780 da
 * 								inizializzare
 * @param[in]		RS_Port		porta GPIO associata al segnale RS
 * @param[in]		RS_Pin		pin di RS_Port associato al segnale RS
 * @param[in]		RW_Port		porta GPIO associata al segnale RW
 * @param[in]		RW_Pin		pin di RW_Port associato al segnale RW
 * @param[in]		E_Port		porta GPIO associata al segnale RE
 * @param[in]		E_Pin		pin di E_Port associato al segnale E
 * @param[in]		Data7_Port	porta GPIO associata al segnale Data7
 * @param[in]		Data7_Pin	pin di Data7_Port associato al segnale Data7
 * @param[in]		Data6_Port	porta GPIO associata al segnale Data6
 * @param[in]		Data6_Pin	pin di Data6_Port associato al segnale Data6
 * @param[in]		Data5_Port	porta GPIO associata al segnale Data5
 * @param[in]		Data5_Pin	pin di Data5_Port associato al segnale Data5
 * @param[in]		Data4_Port	porta GPIO associata al segnale Data4
 * @param[in]		Data4_Pin	pin di Data4_Port associato al segnale Data4
 *
 *
 * @warning Usa la macro assert() per verificare che:
 *          - lcd non sia un puntatore nullo
 ...
 * @param[in] 		Data4 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data4
 * @param[in] 		Data3 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data3
 * @param[in] 		Data2 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data2
 * @param[in] 		Data1 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data1
 * @param[in] 		Data0 	struttura di tipo PortPinPair_t che descrive la coppia porta-pin per il
 * 							segnale Data0
 *
 * @warning Usa la macro assert() per verificare che:
 *          - lcd non sia un puntatore nullo
 ...
 * @param[in]		Data4_Port	porta GPIO associata al segnale Data4
 * @param[in]		Data4_Pin	pin di Data4_Port associato al segnale Data4
 * @param[in]		Data3_Port	porta GPIO associata al segnale Data3
 * @param[in]		Data3_Pin	pin di Data3_Port associato al segnale Data3
 * @param[in]		Data2_Port	porta GPIO associata al segnale Data2
 * @param[in]		Data2_Pin	pin di Data2_Port associato al segnale Data2
 * @param[in]		Data1_Port	porta GPIO associata al segnale Data1
 * @param[in]		Data1_Pin	pin di Data1_Port associato al segnale Data1
 * @param[in]		Data0_Port	porta GPIO associata al segnale Data0
 * @param[in]		Data0_Pin	pin di Data0_Port associato al segnale Data0
 *
 *
 * @warning Usa la macro assert() per verificare che:
 *          - lcd non sia un puntatore nullo
 ...
 * @param[in] lcd display da pilotare;
 * @param[in][in] dir direzione in cui spostare il cursore, @see direction_t;
 * @warning Usa la macro assert() per verificare che lcd non sia un puntatore nullo
 */
